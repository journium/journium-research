...
The numerical illustrations in Sections~\ref{sec:formal} and~\ref{sec:detectors} (Figures~\ref{fig:markov}--\ref{fig:removal} and Table~\ref{tab:scoring}) are reproduced exactly by the public simulation scripts at \url{https://github.com/journium/journium-research}; they serve as worked examples of formal correctness, not as empirical evaluation of a deployed system.
